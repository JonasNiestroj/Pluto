...
LDFLAGS=-melf_i386
KERNOBJ=src/boot/bootloader.o src/kernel/kernel.o src/display/console.o src/architecture/gdt.o src/architecture/idt.o src/architecture/interrupts.o src/architecture/trampoline.o
